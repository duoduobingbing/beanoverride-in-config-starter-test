...
public class SupportMockitoSpyBeanOnConfigurationLevelTest {
    ...
    void test(@Autowired ApplicationContext applicationContext) {
        ...
        Boolean rs = JUnitAssertions.assertDoesNotThrow(() -> Mockito.mockingDetails(foundBean).isSpy());
        JUnitAssertions.assertTrue(rs);

    }

    @Configuration
    @MockitoSpyBean(types = AThing.class)
