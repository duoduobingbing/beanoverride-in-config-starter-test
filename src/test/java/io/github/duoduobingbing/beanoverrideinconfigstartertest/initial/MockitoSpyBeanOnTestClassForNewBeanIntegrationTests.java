...
/**
 * Test {@link org.springframework.test.context.bean.override.mockito.MockitoSpyBean @MockitoSpyBean} on a test class can be used to inject new spy instances.
 *
 */
@ExtendWith(SpringExtension.class)
@Import(SimpleExampleService.class)
@MockitoSpyBean(types = SimpleExampleService.class)
class MockitoSpyBeanOnTestClassForNewBeanIntegrationTests {
