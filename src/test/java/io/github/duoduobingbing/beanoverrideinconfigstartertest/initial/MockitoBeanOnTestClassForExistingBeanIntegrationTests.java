...
/**
 * Test {@link org.springframework.test.context.bean.override.mockito.MockitoBean @MockitoBean} on a test class can be used to replace existing beans.
 *
 */
@ExtendWith(SpringExtension.class)
@MockitoBean(types = IExampleService.class)
class MockitoBeanOnTestClassForExistingBeanIntegrationTests {
