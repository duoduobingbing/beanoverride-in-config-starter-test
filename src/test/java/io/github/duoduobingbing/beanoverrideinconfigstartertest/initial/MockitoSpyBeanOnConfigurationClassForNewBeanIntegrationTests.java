...
/**
 * Test {@link org.springframework.test.context.bean.override.mockito.MockitoSpyBean @MockitoSpyBean} on a configuration class can be used to inject new spy
 * instances.
 *
 */
@ExtendWith(SpringExtension.class)
@Import(SimpleExampleService.class)
class MockitoSpyBeanOnConfigurationClassForNewBeanIntegrationTests {
