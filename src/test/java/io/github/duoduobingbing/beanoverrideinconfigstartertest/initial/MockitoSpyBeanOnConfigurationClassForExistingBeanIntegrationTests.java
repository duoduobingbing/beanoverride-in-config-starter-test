...
/**
 * Test {@link org.springframework.test.context.bean.override.mockito.MockitoSpyBean @MockitoSpyBean} on a configuration class can be used to spy existing
 * beans.
 *
 */
@ExtendWith(SpringExtension.class)
class MockitoSpyBeanOnConfigurationClassForExistingBeanIntegrationTests {
